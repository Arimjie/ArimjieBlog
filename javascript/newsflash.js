 ...
 * Originally written by: Arimjie
 * Website: Arimjie Blog (http://arimjie.blogspot.com)
 *
...
function hn_writeContent(){
    ...
    s += "  <img src='http://3.bp.blogspot.com/-lSt4JkQKDS4/T1sDnjy3cII/AAAAAAAAAno/d7q--XKJpCk/s1600/Untitled-1.png'";
    s += " height='20'/>";
    s += " </a>";
    s += "</div>";
    ...
    if(hn_backlink == true | hn_backlink == undefined){
        ...
        s += "  Widget by <br/>";
        s += "  <a href='http://arimjie.blogspot.com/2012/01/.html'>";
